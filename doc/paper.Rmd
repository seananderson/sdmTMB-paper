...
However, after rapid model exploration with maximum likelihood, one can pass an sdmTMB model to the R package tmbstan [@monnahan2018] to estimate the joint posterior distribution.
