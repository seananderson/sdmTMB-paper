...
basic optimization details - random effects conditional...
...
At a minimum, an sdmTMB model requires a data frame that contains a response column, columns for any predictors, and columns for spatial coordinates.
...
The random fields are constructed as Gaussian Markov random fields (GMRF), where the random effects are structured as MVN constrained by a Matérn covariance function. Additional details are provided in the SI.
