...
First, the smoothers typically used with mgcv (thin plate splines, ...), while capable of making equivalent predictions [@miller2019; @pedersen2019] do not offer the ecological interpretability of a spatially explicit random field model (spatial range and variance).
