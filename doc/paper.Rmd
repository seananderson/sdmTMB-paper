...
Because of the well documented biases of AIC with hierarchical or mixed-effects models [@liang2008] we also provide functionality to perform estimation via k-fold  cross-validation. 
Our wrapper function `sdmTMB_cv()` allows for any number of folds, with assignments being user-specified or chosen randomly. 
