...
To our knowledge, VAST is the only package to implement spatial (REF) and spatial dynamic factor analysis (REF) and spatial empirical orthogonal function (EOF) regression (REF).
