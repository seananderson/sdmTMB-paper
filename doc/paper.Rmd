...
# 2. Estimate a spatially varying effect from citizen science data
...
We found a weak average positive effect of annual mean NAO on overall counts, but a marked southeast to northwest gradient in the intensity of the effect (Fig. \@ref(fig:owl-nao), Appendix 3).
