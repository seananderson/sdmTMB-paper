...
For example, sdmTMB provides functionality for generating population-level summaries for each time slice including fraction of area occupied (TODO?), 2-dimensional center of gravity (`sdmTMB::get_cog()`), and total population index (`sdmTMB::get_index()`).
