...
Future development may include zero-inflated models, improvements to Bayesian sampling efficiency, continuous time models (REF?), and non-gaussian random fields [e.g., @anderson2019].
