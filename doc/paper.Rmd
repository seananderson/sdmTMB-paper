...
- Thinking of application with broad interest or a dataset that is pretty well known. Trawl surveys are great obv, and there's lots of examples worked out
- gorillas dataset from spatstat/inlabru: https://rdrr.io/cran/spatstat.data/man/gorillas.html -- only prob is it's not time-varying
- Spatial rainfall dataset from INLA? https://becarioprecario.bitbucket.io/spde-gitbook/ch-stapp.html
- Simulating a dataset could be used to highlight sim() function 
- 
...
- Probably some discussion of speed. Comparison of one of the models in the application above to INLA? Or other software, e.g. Stan -- though that's not as fair :)
