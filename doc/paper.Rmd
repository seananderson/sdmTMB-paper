...
The data frame `qcs_grid` is a grid that extends over the full survey domain and contains all predictors used in the model set at values for which we we want to predict.
...
We could extend our model to a spatiotemporal model simply by supplying the year column name to the `time` argument and specifying how we want the spatiotemporal random fields to be structured.
