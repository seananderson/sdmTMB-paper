...
knitr::kable(d, format = "latex", caption = "Comparison of functionality between five R packages that can fit SPDE-based geostatistical GLMMs.", 
  booktabs = TRUE, 
  linesep = c(
    rep('', 4), # coefs
    '\\addlinespace',
    rep('', 3), # correlation stuff
    '\\addlinespace',
    rep('', 10), # likelihood
    '\\addlinespace',
    rep('', 2), # bayes
