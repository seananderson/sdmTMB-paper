...
In this test, sdmTMB was the fastest; however, inlabru/INLA and spaMM were less affected by mesh resolution than sdmTMB.
...
These speed increases can allow for more rapid and thorough model exploration and experimentation with a class of models that are generally slower to fit than GLMMs without random fields.
...
Furthermore, although both INLA/inlabru and sdmTMB can use parallel processing, the PARDISO library [@pardiso-7.2c] within INLA/inlabru allows memory to be shared across cores allowing for better scaling with very large models.
