...
For some models, TMB/sdmTMB can be considerably faster than INLA/inlabru [@osgood-zimmerman2021], but in our experience, those differences will depend on many aspects of models specification (Supp fig?).
