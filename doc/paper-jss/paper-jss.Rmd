...
coast of Vancouver Island, British Columbia, Canada. We will fit a logistic
regression of encounter probability with and without spatial random fields to
illustrate the importance of accounting for spatial correlation.
...
We can also see that the AIC is considerably lower:
...
We can use `update()` to refit our model with four additional families:
