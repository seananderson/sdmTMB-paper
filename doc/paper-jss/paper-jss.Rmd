...
```{r child="model-description.Rmd", eval=TRUE}
```

```{r child="pcod.Rmd", eval=TRUE}
```

```{r child="owls.Rmd", eval=TRUE}
```

```{r child="inla-comparison.Rmd", eval=TRUE}
```

```{r child="timing.Rmd", eval=TRUE}
```
