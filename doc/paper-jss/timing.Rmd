# Speed testing related packages
...
```{r mesh-vis-timing, out.width="6.5in", fig.width=10, fig.asp=1.2, echo=FALSE}
...
```{r sim-dat-plot-timing, out.width="5in", cache=FALSE, echo=FALSE}
