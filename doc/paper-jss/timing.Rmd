...
```{r mesh-vis-timing, fig.width=7, fig.asp=1.1, echo=FALSE, fig.cap="The meshes used in simulations from least to most vertices.", fig.pos='h', fig.align='center'}
...
```{r sim-dat-plot-timing, out.width="5in", echo=FALSE, fig.cap="The meshes used in simulations from least to most vertices.", fig.pos='h', fig.align='center'}
...
```{r mgcv-spde-funcs-timing, echo=FALSE, eval=TRUE, cache=TRUE}
# -------------------------------------------------------------------------
...
```{r mgcvfit-timing, echo=TRUE, eval=FALSE}
