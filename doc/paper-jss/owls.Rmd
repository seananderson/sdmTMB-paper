...
```{r plot-fixed-effects-owls, echo=FALSE, eval=TRUE, dpi=210, fig.cap="The colour of each year represents the non-random field based elements in this model.", fig.pos='h', fig.align='center'}
ggplot(data = filter(p_proj, year > 1978)) +
  geom_point(
