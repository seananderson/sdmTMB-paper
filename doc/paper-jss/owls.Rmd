...
```{r mesh-owls, echo=TRUE, out.width="4in", fig.cap="Mesh used for model is based on X and Y that use an Albers projection divided by 100000 to give units of 100 km and a cutoff distance of 1.5 units (or 150 km).", fig.pos='h', fig.align='center'}
...
```{r plot-all-effects-owls, echo=FALSE, eval=TRUE, dpi=220, fig.cap="Predicted winter owl counts that incorporate all fixed effects and random effects.", fig.pos='h', fig.align='center'}
ggplot(data = p_proj) +
...
```{r plot-spatiotemporal-effects-owls, echo=FALSE, eval=TRUE, dpi=210, fig.cap="Spatiotemporal random effects.", fig.pos='h', fig.align='center'}
...
```{r plot-fixed-effects-owls, echo=FALSE, eval=TRUE, dpi=210, fig.cap="The facet colours represent the non-random field based elements in this model.", fig.pos='h', fig.align='center'}
ggplot(data = filter(p_proj, year > 1978)) +
  geom_point(
