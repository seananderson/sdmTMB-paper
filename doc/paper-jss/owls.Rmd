...
```{r plot-all-effects-owls, out.width="95%", fig.asp=0.8, echo=FALSE, eval=TRUE, dpi=300, fig.cap="Predicted winter owl counts that incorporate all fixed effects and random effects.", fig.pos='h', fig.align='center'}
ggplot(data = p_proj) +
...
```{r plot-spatiotemporal-effects-owls, out.width="95%", fig.asp=0.8, echo=FALSE, eval=TRUE, dpi=300, fig.cap="Spatiotemporal random effects.", fig.pos='h', fig.align='center'}
...
```{r plot-fixed-effects-owls, out.width="95%", fig.asp=0.8, echo=FALSE, eval=TRUE, dpi=300, fig.cap="Predictions for each year based on only the non-random field elements.", fig.pos='h', fig.align='center'}
ggplot(data = filter(p_proj, year > 1978)) +
  geom_point(
