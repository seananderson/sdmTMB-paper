...
<<mesh-vis-timing, fig.width=7, fig.asp=1.1, out.width="4in", echo=FALSE, fig.cap="The meshes used in simulations from least to most vertices.", fig.pos='ht', fig.align='center'>>=
