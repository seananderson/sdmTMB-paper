...
## ----child="model-description.Rmd", eval=FALSE----------------
## NA


## ----child="pcod.Rmd", eval=TRUE, cache=TRUE------------------
...
## ----child="owls.Rmd", eval=TRUE, cache=TRUE------------------

## ----owl-knitr-setup, include=FALSE---------------------------
knitr::opts_chunk$set(
  dpi = 125,
  dev = "png",
  optipng = "-strip all"
...
## ----child="inla-comparison.Rmd", eval=TRUE, cache=TRUE-------
...
## ----compare-plot, out.width="6in", fig.cap="Blue histograms represent simulated draws from the joint precision matrix of the \\pkg{sdmTMB} model compared with the marginal posterior densities from the \\pkg{INLA} model.", fig.align='center'----
ggplot(post_inla2) +
  geom_histogram(
...
## ----child="timing.Rmd", eval=TRUE, cache=TRUE----------------
