...
This appendix uses the following notation conventions, generally following the guidance in @edwards2019:
...
* $\omega_{\bm{s}}$ represents a random spatial component (a random field), $\omega_{\s} \sim \mathrm{MVN}(\bm{0},\bm{\Sigma}_\omega)$; and
