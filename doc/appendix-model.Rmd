...
$$
\begin{aligned}
  \mu_{\s,t} &= f^{-1} \left( \ldots + \gamma_{t} \bm{X}_{2,s,t} + \ldots \right),\\
...
The Tweedie distribution can be helpful for modelling data that are positive and continuous but also contains zeros.
