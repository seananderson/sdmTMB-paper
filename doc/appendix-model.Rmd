...
[Source code](https://kaskr.github.io/adcomp/tweedie_8cpp_source.html) as in the [cplm](https://CRAN.R-project.org/package=cplm) package [@zhang2013a].
...
and $\kappa$ controls the spatial correlation range.
