...
Below, we add a tiny jitter amount (`0.04`) to the mgcv output just so the two smoothers can both be visualized.
...
lines(df$x2, df$est + 0.04, col = "blue")
lines(df$x2, df$lwr + 0.04, lty = 2, col = "blue")
lines(df$x2, df$upr + 0.04, lty = 2, col = "blue")
```
