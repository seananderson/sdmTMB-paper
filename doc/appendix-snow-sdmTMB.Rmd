...
The simulation draws for both can then be combined before calculating the median and lower and upper quantiles from these draws and adding these values to our prediction data frame.
