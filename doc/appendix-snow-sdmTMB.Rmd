...
This projection was achieved with the following crs code using `sf::st_transform(crs = Albers)`. 
...
saveRDS(r_mcmc, "mcmc_residuals.rds")
```

```{r stan-dat, echo=FALSE, cache=FALSE}
r_mcmc <- readRDS(here::here("owls/mcmc_residuals.rds"))
```
...
We retrieved continental coastlines from the package rnaturalearth and outlines of the great lakes from [http://www.naturalearthdata.com/](http://www.naturalearthdata.com/) and transformed them to the correct projection.

```{r shapes}
coast <- rnaturalearth::ne_coastline(scale = "medium", returnclass = "sf") %>% 
  sf::st_transform(crs = Albers) 
lakes <- sf::st_read(here::here("owls/ne_10m_lakes"),  quiet = TRUE)
