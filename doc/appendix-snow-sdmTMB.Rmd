...
```{r mesh, echo=TRUE, cache=FALSE, out.width="4in"}
...
```{r plot-map, echo=TRUE, eval=TRUE, out.width="90%", cache=FALSE}
ggplot(data = p_proj) +
  geom_point(
...
```{r plot-map-ci, echo=F, eval=TRUE, out.width="90%", cache=FALSE}
