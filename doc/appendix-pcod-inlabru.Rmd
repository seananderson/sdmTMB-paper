---
title: "Annotated example of index standardization with inlabru"
output:
  pdf_document:
    highlight: tango
---
...
```{r}
sdmtmb_fit <- sdmTMB(present ~ -1 + as.factor(year), data = pcod,
   time = "year", spde = mesh, 
...
fit2 <- bru(components = components,
             family = "binomial", data = dat)
