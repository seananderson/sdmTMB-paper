...
abstract: >
  ...
  sdmTMB's accessible interface has already opened this useful class of models to a wider audience within species distribution modelling. We anticipate its application to the full spectrum of novel ecological problems that involve geostatistical data will prove equally fruitful.
output:
  bookdown::pdf_book:
